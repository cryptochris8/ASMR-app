...
export class TempleZenScene implements IScene {
  readonly id = 'temple-zen';
  ...
  constructor() {
    ...
    this.trailMesh.name = 'temple-touch-zone';
  ...
  drawTrail(u: number, v: number): void {
    ...
    if (this.lastU >= 0) {
      ...
      this.trailCtx.strokeStyle = 'rgba(40, 28, 16, 0.32)';
